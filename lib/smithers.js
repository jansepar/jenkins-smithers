            ...
            if(error) {
               jenkins.copy_job(baseJob
                               ...
                               ,function(configFile) {
                                    ...
                                    var newConfigFile = configFile.replace(baseJob, jobName);
				    newConfigFile = newConfigFile.replace(/<branches>[\S\s]*?<\/branches>/, 
                                           '<branches><hudson.plugins.git.BranchSpec><name>' + branch
                               ...
                               ,function(error, data) {
                                    if(!error) {
                                        ...
                                        console.error("Error copying job, ", error, data);
                                        return;
                                    }
